...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "17/2": titulo = "17 de FEVEREIRO de 2024"; mensagem = "<p>Esse foi o dia que nos conhecemos e conheci sua familia(nosso primeiro encontro)! E percebemos que dali pra frente poderiamos ter alguma coisa juntos.</p><p>";break;
            case "24/2": titulo = "24 de FEVEREIRO de 2024"; mensagem = "<p>Foi a segunda vez que nos vimos e seu pai e vc foram me buscar e eu estava morrendo de vergonha. Foi o dia que faltou luz enquanto viamos filme de terror(Maldição da chorona)";break;
            case "final": titulo = "24 de Março 2024"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
